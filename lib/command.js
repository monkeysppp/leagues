...
function run (args) {
  ...
  return new Promise((resolve, reject) => {
    ...
    command.command('addUser <databaseHostname> <databaseName> <databaseUser> <username>')
      .description('Add a single user to the user\'s database')
      .action((databaseHostname, databaseName, databaseUser, username) => {
        module.exports.internal.addUser(databaseHostname, databaseName, databaseUser, username).then(resolve, reject)
      })
 ...
 */
function addUser (databaseHostname, databaseName, databaseUser, username) {
  return addUserLib.addUser(databaseHostname, databaseName, databaseUser, username)
}
