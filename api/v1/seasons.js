...
exports.seasonsSeasonIdCompetitionsCompetitionIdFixturesPost = function (req, res, next) {
  log.info('POST /v1/seasons/' + parseInt(req.params.seasonId) + '/competitions/' + parseInt(req.params.competitionId) + '/fixtures ' + req.body)
...
exports.seasonsSeasonIdCompetitionsCompetitionIdFixturesFixtureIdPut = function (req, res, next) {
  log.info('PUT /v1/seasons/' + parseInt(req.params.seasonId) + '/competitions/' + parseInt(req.params.competitionId) + '/fixtures/' + parseInt(req.params.fixtureId) + ' ' + req.body)
